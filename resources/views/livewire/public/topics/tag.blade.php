        ...
        <div class="container mx-auto px-6">
            ...
            <div class="lg:col-span-3 space-y-10">
                ...
                <nav class="text-sm mb-6 border-b border-gray-200 pb-5">
                    ...
                    <li class="text-gray-400">›</li>
                    <li>
                        <a href="/topics/{{ $this->tag->topic->id }}" class="text-brown-600 dark:text-neutral-100 font-medium hover:underline">{{ $this->tag->topic->name }}</a>
                    </li>
                    <li class="text-gray-400">›</li>
                ...
                <!-- Topic Header -->
                <div>
                <x-public.section-heading>Tag: {{ $this->tag->name }}</x-public.section-heading>
                
                </div>

                @if ($this->tag->posts->count())
                    <!-- Posts under this Topic -->
                    <div class="space-y-10 mt-8">
                        <p class="text-gray-600 dark:text-neutral-100 mt-3 leading-relaxed">
                            These are the posts related to tag "{{ $this->tag->name }}"
                        </p>


                        @foreach ($this->tag->posts as $post)
                            <x-public.post-card>
