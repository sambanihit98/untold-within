...
new #[Layout('components.layouts.private.app')] class extends Component {
    ...
    public $middlename = '';
    public $birthdate, $gender, $phonenumber, $email;
    ...
    {
        $validated = $this->validate([
            'username' => ['required', 'string', 'max:255', Rule::unique('admins', 'username')->ignore($this->user->id)],
            'firstname'      => ['required', 'string', 'max:255'],
            'middlename'     => ['nullable', 'string', 'max:255'],
            'lastname'       => ['required', 'string', 'max:255'],
            'birthdate'      => ['required', 'date'],
            'gender'         => ['required', Rule::in(['Male','Female','Other'])],
            'phonenumber'    => ['required', 'string', 'max:255', Rule::unique('admins', 'phonenumber')->ignore($this->user->id)],
            'email'          => ['required', 'string', 'email', 'max:255', Rule::unique('admins', 'email')->ignore($this->user->id),
            ],
        ]);
