...
<div class="flex flex-col gap-6 p-6">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-5">
        <div class="p-4 border rounded-xl bg-white dark:bg-neutral-900 border-gray-200 dark:border-neutral-700 shadow-sm">
            <p class="text-sm text-gray-500 dark:text-gray-400 mb-1">Total Followers</p>
            <p class="text-2xl font-bold text-brown-900 dark:text-neutral-100">{{ $this->totalFollowers }}</p>
        </div>
        <div class="p-4 border rounded-xl bg-white dark:bg-neutral-900 border-gray-200 dark:border-neutral-700 shadow-sm">
            <p class="text-sm text-gray-500 dark:text-gray-400 mb-1">New Followers (This Month)</p>
            <p class="text-2xl font-semibold text-brown-900 dark:text-neutral-100">+{{ $this->followersThisMonth }}</p>
        </div>
    </div>
    ...
    <div class="flex items-center justify-between ">
        ...
        <div class="relative">
            <input 
                ...
                class="pl-10 pr-4 py-2 rounded-lg border border-gray-300 dark:border-neutral-700 bg-white dark:bg-neutral-900 focus:ring-2 focus:ring-brown-600 dark:focus:ring-cyan-600 focus:outline-none w-64 dark:text-neutral-200"
            >
