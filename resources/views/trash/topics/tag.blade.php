      ...
      <div class="lg:col-span-3 space-y-10">
        ...
        <nav class="text-sm border-b border-gray-200 pb-4">
          <ol class="flex items-center space-x-2">
            ...
            <li class="text-gray-400">›</li>
            <li>
              <a href="/topics/1" class="text-[#A67C52] font-medium hover:underline">Emotions</a>
            </li>
            <li class="text-gray-400">›</li>
        ...
        <!-- Topic Header -->
        <div>
          <x-public.section-heading>Tag: Happiness</x-public.section-heading>
        ...
        <div class="space-y-10 mt-8">
            <p class="text-gray-600 mt-3 leading-relaxed">
                These are the posts related to tag "Happiness"
            </p>
